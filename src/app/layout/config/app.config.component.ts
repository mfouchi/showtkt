      ...
      <div class="layout-config-content">
        ...
        <p-tabView id="config-form-tabs">
          <p-tabPanel header="Light or Dark">
            <h1>Light or Dark</h1>
            <p>
              Mirage offers all dark dashboard &amp; theme design for dark
              lovers.
            </p>
          ...
          <p-tabPanel header="Menu">
            ...
            <div class="p-grid">
              <div
                class="p-col p-col-fixed"
                *ngFor="let menuColor of menuColors"
              >
                <a
                  href="#"
                  class="layout-config-option layout-config-option-image"
                ...
                >
                  ...
                  <i
                    class="pi pi-check"
                    *ngIf="menuColor.name === app.menuColorMode"
                  ></i>
                </a>
              </div>
            </div>
            ...
            <div class="p-grid">
              <div
                class="p-col p-col-fixed"
                *ngFor="let menuTheme of selectedColorOptions"
              >
                <a
                  href="#"
                ...
                >
                  ...
                  <i
                    class="pi pi-check"
                    *ngIf="
                      app.menuColorMode === 'custom' &&
                      'layout-menu-' + menuTheme.file === app.menuColor
                    "
                  ></i>
                  <i
                    class="pi pi-check"
                    *ngIf="
                      app.menuColorMode !== 'custom' &&
                      menuTheme.file === app.layoutColor
                    "
                  ></i>
                </a>
              </div>
          ...
          <p-tabPanel header="Components">
            <div class="p-grid">
              <div
                class="p-col p-col-fixed"
                *ngFor="let componentTheme of componentThemes"
              >
                <a
                  href="#"
                  class="layout-config-option layout-config-option-image layout-config-option-theme"
...
export class AppConfigComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.menuColors = [{ name: "light" }, { name: "custom" }, { name: "dark" }];
