      ...
      <div class="layout-topbar-wrapper">
        <div class="layout-topbar-left">
          ...
          <a
            ...
            (click)="app.onTopbarMobileMenuButtonClick($event)"
          >
          ...
          <div class="layout-megamenu-wrapper">
            ...
            <ul
              ...
              [ngClass]="{
                'layout-megamenu-active fadeInDown': app.megaMenuActive
              }"
              (click)="app.onMegaMenuClick($event)"
            >
              <li
                [ngClass]="{ 'active-topmenuitem': activeItem === 1 }"
              ...
              <li
                [ngClass]="{ 'active-topmenuitem': activeItem === 2 }"
              ...
              <li
                [ngClass]="{ 'active-topmenuitem': activeItem === 3 }"
                (click)="mobileMegaMenuItemClick(3)"
              >
        ...
        <div class="layout-topbar-right fadeInDown">
          <ul class="layout-topbar-actions">
            <li
              ...
              [ngClass]="{
                'active-topmenuitem': app.activeTopbarItem === search
              }"
            >
              <a
                href="#"
              ...
              <ul
                class="search-item-submenu fadeInDown"
                (click)="app.topbarItemClick = true"
              >
                <li>
            ...
            <li
              ...
              class="topbar-item"
              [ngClass]="{
                'active-topmenuitem': app.activeTopbarItem === calendar
              }"
            >
            ...
            <li
              ...
              class="topbar-item"
              [ngClass]="{
                'active-topmenuitem': app.activeTopbarItem === message
              }"
            >
              ...
              <ul class="fadeInDown">
                ...
                <li class="layout-submenu-item">
                  <img
                    src="assets/layout/images/topbar/avatar-gabie.png"
                    alt="mirage-layout"
                    width="35"
                  />
                  <div class="menu-text">
                ...
                <li class="layout-submenu-item">
                  <img
                    src="assets/layout/images/topbar/avatar-gaspar.png"
                    alt="mirage-layout"
                    width="35"
                  />
                  <div class="menu-text">
                ...
                <li class="layout-submenu-item">
                  <img
                    src="assets/layout/images/topbar/avatar-tatiana.png"
                    alt="mirage-layout"
                    width="35"
                  />
                  <div class="menu-text">
            ...
            <li
              ...
              class="topbar-item"
              [ngClass]="{
                'active-topmenuitem': app.activeTopbarItem === gift
              }"
            >
              ...
              <ul class="fadeInDown">
                ...
                <li class="deals">
                  <ul>
                    <li>
                      <img
                        src="assets/layout/images/topbar/deal-icon-sapphire.png"
                        alt="mirage-layout"
                        width="35"
                      />
                      <div class="menu-text">
                    ...
                    <li>
                      <img
                        src="assets/layout/images/topbar/deal-icon-roma.png"
                        alt="mirage-layout"
                        width="35"
                      />
                      <div class="menu-text">
                    ...
                    <li>
                      <img
                        src="assets/layout/images/topbar/deal-icon-babylon.png"
                        alt="mirage-layout"
                        width="35"
                      />
                      <div class="menu-text">
                  ...
                  <ul>
                    <li>
                      <img
                        src="assets/layout/images/topbar/deal-icon-harmony.png"
                        alt="mirage-layout"
                        width="35"
                      />
                      <div class="menu-text">
                    ...
                    <li>
                      <img
                        src="assets/layout/images/topbar/deal-icon-prestige.png"
                        alt="mirage-layout"
                        width="35"
                      />
                      <div class="menu-text">
                    ...
                    <li>
                      <img
                        src="assets/layout/images/topbar/deal-icon-ultima.png"
                        alt="mirage-layout"
                        width="35"
                      />
                      <div class="menu-text">
            ...
            <li
              ...
              [ngClass]="{
                'active-topmenuitem': app.activeTopbarItem === profile
              }"
            >
              <a href="#" (click)="app.onTopbarItemClick($event, profile)">
                <span class="profile-image-wrapper">
                  <img
                    src="assets/layout/images/topbar/avatar-rivertown.png"
                    alt="mirage-layout"
                  />
                </span>
              ...
              <ul class="profile-item-submenu fadeInDown">
                <li class="profile-submenu-header">
                  <div class="performance">
                    ...
                    <img
                      src="assets/layout/images/topbar/asset-bars.svg"
                      alt="mirage-layout"
                    />
                  </div>
                  <div class="profile">
                    <img
                      src="assets/layout/images/topbar/avatar-eklund.png"
                      alt="mirage-layout"
                      width="40"
                    />
                    <h1>Olivia Eklund</h1>
          ...
          <ul class="profile-mobile-wrapper">
            ...
            >
              <a
                href="#"
                (click)="app.onTopbarItemClick($event, mobileProfile)"
              >
                <span class="profile-image-wrapper">
                  <img
                    src="assets/layout/images/topbar/avatar-eklund.png"
